...
def train_pca():
    ...
    # Ładowanie danych (zakładam domyślny batch_size 32)
    ...
    epochs = 3 # Dla ekstraktora statystycznego powinno wystarczyć na początek
    best_loss = float('inf')
    ...
    for epoch in range(epochs):
        ...
        # Checkpointing (zapisywanie najlepszego modelu)
        if epoch_loss < best_loss:
            best_loss = epoch_loss
            torch.save(model.state_dict(), "best_gradient_pca_model.pt")
